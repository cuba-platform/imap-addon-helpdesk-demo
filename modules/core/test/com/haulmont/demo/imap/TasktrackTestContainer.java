package com.haulmont.demo.imap;
...
public class TasktrackTestContainer extends TestContainer {

    public TasktrackTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/demo/imap/app.properties",
    ...
    public static class Common extends TasktrackTestContainer {

        public static final TasktrackTestContainer.Common INSTANCE = new TasktrackTestContainer.Common();
